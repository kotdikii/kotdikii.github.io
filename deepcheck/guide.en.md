...
- **Settings** — choose theme, palette and language.
...
- **Palette** — the colors of DeepCheck or of one of the sibling apps (Deedary, Seriary). It works together with the theme: every palette has both a light and a dark variant.
